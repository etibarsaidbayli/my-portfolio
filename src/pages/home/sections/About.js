    ...
    return (
            <SectionWrapper themeColor={themeColor} className='mt-5 row'>
                ...
                <main className="col-md-8">
                    <p>i am professional web developer with <strong>1 + year experience in web development</strong>.I'm constantly developing and learning new technologies in IT.</p>
                    <p>
                        The Front-End development is where <strong>i feel 100% comfortable
                            </strong>
