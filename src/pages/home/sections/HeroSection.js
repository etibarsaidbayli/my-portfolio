            ...
            <div  className="h-100 d-flex flex-column align-items-center align-items-md-start justify-content-center">
                ...
                <div className="row flex-column-reverse flex-md-row">
                    <div className="col-md-9">
                        ...
                        <div>
                            <MainTitle className='mb-2'>hi, <SpanTheme themeColor={themeColor}> Etibar </SpanTheme> here.</MainTitle>
                            <SecondaryTitleTheme themeColor={themeColor}>I build stuff sometimes.</SecondaryTitleTheme>
                        </div>
                        <HeroTextContainer className="pt-4 pb-4 pb-md-5">I'm a front-end developer based in Azerbaijan and i love learning everything that helps me express my creativity.</HeroTextContainer>
                        <AnchorTheme
                            ...
                            <AnchorTheme
                                themeColor={themeColor}
                                href="https://drive.google.com/file/d/1-YZlUy4LAcCrFij5zi7Kw1DyC8hIi2kx/view?usp=sharing"
                                target="_blank"
                                rel="noreferrer"
                                download 
                                className="btn px-5 py-3">
